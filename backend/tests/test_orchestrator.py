                ...
                with patch('app.rag.orchestrator.AgenticRAG') as mock_agentic:
                    with patch('app.rag.orchestrator.QueryAnalyzer') as mock_analyzer:
                        ...
                        async def simple_stream(*args, **kwargs):
                            ...
                            yield StreamChunk(type="done", metrics=RetrievalMetrics(
                        ...
                        orchestrator.agentic_rag.process_query_streaming = agentic_stream
...
class TestRAGOrchestratorAutoEscalation:
            ...
            with patch('app.rag.orchestrator.HybridRAG') as mock_hybrid:
                with patch('app.rag.orchestrator.AgenticRAG') as mock_agentic:
                    with patch('app.rag.orchestrator.QueryAnalyzer'):
                        ...
                        orchestrator.simple_rag.process_query_streaming = low_confidence_stream
                        orchestrator.hybrid_rag.process_query_streaming = medium_confidence_stream
                        orchestrator.agentic_rag.process_query_streaming = high_confidence_stream
    ...
    @pytest.mark.asyncio
    async def test_escalates_to_agentic_on_continued_low_confidence(self, mock_orchestrator):
                    ...
                    with patch('app.rag.orchestrator.QueryAnalyzer') as mock_analyzer:
                        ...
                        orchestrator.simple_rag.retrieve_context = AsyncMock(
                            return_value=(
                                ...
                                RetrievalMetrics(query_time_ms=100, num_results=1, reranked=False)
                            )
                        )

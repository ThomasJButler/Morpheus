...
Based on preserved code from MorpheusRAGLearningDocuments/original-code/query_rewriter.py
"""
...
async def decompose_query(query: str) -> List[str]:
    """
    Quick query decomposition function.

    Args:
        query: Complex query to break down

    Returns:
        List of sub-queries
    """
    rewriter = QueryRewriter()
    return await rewriter.decompose_query(query)

...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Main Content */}
      <div className="relative z-10 container mx-auto px-2 sm:px-4 py-1 sm:py-2">
        {/* Header - Enhanced */}
        <header className="mb-2 flex items-center justify-center gap-3 sm:gap-4">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl font-bold gradient-text-animated font-mono hover:text-glow-green transition-all cursor-default">
              MORPHEUS
            </h1>
            <p className="text-matrix-green-dim/60 text-[10px] sm:text-xs font-mono tracking-wider">
        ...
        <footer className="mt-2 text-center">
          <div className="inline-flex items-center gap-4 text-matrix-white/30 text-xs font-mono">
            ...
            <span className="hidden sm:inline text-matrix-green/30">•</span>
            <span className="hidden sm:inline text-matrix-white/20">

...
export default function ChatInterface() {
  ...
  // MOCK MESSAGES FOR TESTING MOBILE SCROLL - REMOVE AFTER TESTING
  const mockMessages = [
    { id: '1', role: 'user' as const, content: 'What is the Matrix?', createdAt: new Date() },
    { id: '2', role: 'assistant' as const, content: 'The Matrix is a 1999 science fiction action film written and directed by the Wachowskis. It depicts a dystopian future in which humanity is unknowingly trapped inside a simulated reality, the Matrix, which intelligent machines have created to distract humans while using their bodies as an energy source.\n\nThe film stars Keanu Reeves as Neo, a computer programmer who discovers the truth about the Matrix and joins a rebellion against the machines. The movie explores themes of reality, identity, and free will.\n\n*pauses thoughtfully*\n\nThe red pill or the blue pill, Neo?', createdAt: new Date() },
    { id: '3', role: 'user' as const, content: 'Tell me more about the philosophical themes', createdAt: new Date() },
    { id: '4', role: 'assistant' as const, content: '**The Matrix** explores several deep philosophical themes:\n\n## 1. Simulacra and Simulation\nThe film draws heavily from Jean Baudrillard\'s work, questioning what is "real" in a world of constructed realities.\n\n## 2. The Allegory of the Cave\nPlato\'s famous allegory is central - humans in the Matrix are like prisoners seeing shadows, mistaking them for reality.\n\n## 3. Free Will vs Determinism\nThe Oracle\'s prophecies raise questions about choice and fate. Does Neo truly choose, or is everything predetermined?\n\n## 4. Mind-Body Dualism\nThe separation of consciousness (in the Matrix) from physical bodies (in pods) echoes Descartes\' philosophy.\n\n## 5. Buddhism and Enlightenment\nNeo\'s journey mirrors the path to enlightenment - awakening from illusion to see true reality.\n\n> "There is no spoon."\n\nThis famous line encapsulates the film\'s message: reality is perception, and perception can be changed.', createdAt: new Date() },
    { id: '5', role: 'user' as const, content: 'What about the sequels?', createdAt: new Date() },
    { id: '6', role: 'assistant' as const, content: 'The Matrix trilogy continued with two sequels released in 2003:\n\n### The Matrix Reloaded\n- Expands the mythology significantly\n- Introduces the Architect and reveals Neo is not the first "One"\n- Famous freeway chase sequence\n- Explores the concept of choice more deeply\n\n### The Matrix Revolutions\n- Concludes the original trilogy\n- Battle for Zion against the machines\n- Neo\'s sacrifice and the truce with machines\n- More divisive among fans\n\n### The Matrix Resurrections (2021)\n- Lana Wachowski returned solo to direct\n- Meta-commentary on the franchise itself\n- Explores themes of nostalgia and corporate exploitation\n- Mixed reception but interesting thematic territory\n\nThe sequels expanded the universe but many feel the original stands alone as a masterpiece. The philosophical depth became more convoluted, though the action remained impressive.\n\n*adjusts sunglasses*\n\nWhich aspects would you like to explore further?', createdAt: new Date() },
  ];
  ...
  // USE MOCK MESSAGES FOR TESTING - REMOVE AFTER TESTING
